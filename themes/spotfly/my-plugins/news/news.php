...
wp_enqueue_style('my-content-styles', get_theme_file_uri('/my-plugins/news/news.css'), false, '1.0');
wp_register_script('my-script', get_theme_file_uri('/common.js'), array('jquery'), '1.0', true);
wp_register_script('my-content-script', get_theme_file_uri('/my-plugins/news/news.js'), array('jquery'), '1.0', true);
...
<div>
    ...
    <div class="my-content" id="my-content">
        <h3>
            媒体链接列表
            <button class="button-primary my-content__add">添加媒体链接</button>
